...
//Video
    const menuBtn = document.querySelector(".menu-btn");
        ...
        // Fungsi untuk menginisialisasi tampilan halaman pada load
document.addEventListener("DOMContentLoaded", function () {
    sliderNav(0); // Panggil fungsi sliderNav dengan parameter 0 untuk mengaktifkan elemen pertama saat halaman dimuat
});
